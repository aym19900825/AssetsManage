							...
							<el-collapse-item title="基本信息" name="1">
								<div class="accordion-body tab-content" v-show="col_but1" id="tab-content2">
									<el-row :gutter="70">
										...
										<el-col :span="8">
											<el-form-item label="单位名称" prop="description">
												<el-input v-model="dataInfo.description"></el-input>
											</el-form-item>
										</el-col>
										<el-col :span="8">
											<el-form-item label="联系地址" prop="description">
												<el-input v-model="dataInfo.description"></el-input>
											</el-form-item>
										</el-col>
									</el-row>
									<el-row :gutter="70">
										...
										<el-col :span="8">
											<el-form-item label="邮政编码" prop="description">
												<el-input v-model="dataInfo.description"></el-input>
											</el-form-item>
										</el-col>
										<el-col :span="8">
									...
									<el-row :gutter="70">
										<el-col :span="8">
											<el-form-item label="录入日期" prop="name">
												<el-input v-model="dataInfo.name"></el-input>
											</el-form-item>
										</el-col>
										<el-col :span="8">
									...
									<el-row :gutter="70">
										<el-col :span="24">
											<el-form-item label="备注" prop="name">
												<el-input v-model="dataInfo.name" type="textarea"></el-input>
											</el-form-item>
										</el-col>
									</el-row>
								</div>
