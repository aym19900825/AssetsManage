				...
				<div class="ibox-content">
					...
					<div v-show="search">
						<el-form inline-message :model="searchList" label-width="100px">
							<el-row :gutter="10">
								<el-col :span="5">
									<el-form-item label="登录描述" prop="logname">
					...
					<el-row :gutter="0">
						<el-col :span="24">
							...
							<v-table ref="table" :appName="appName" :searchList="searchList" @getSelData="setSelData">
								<el-table-column label="登录描述" width="300" prop="logname" v-if="checkedName.indexOf('登录描述')!=-1">
								</el-table-column>
								<el-table-column label="登录账号" width="200" sortable prop="username" v-if="checkedName.indexOf('登录账号')!=-1">
								</el-table-column>
								<el-table-column label="登录IP" prop="ip" v-if="checkedName.indexOf('登录IP')!=-1">
								</el-table-column>
								<el-table-column label="登录时间" width="180" sortable prop="createtime" v-if="checkedName.indexOf('登录时间')!=-1">
								</el-table-column>
							</v-table>
							<!-- 表格 End-->
						</el-col>
