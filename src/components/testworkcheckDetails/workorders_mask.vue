			...
			<div class="mask_div">
				...
				<div class="mask_content">
					...
					<el-form inline-message :model="workorderForm" :label-position="labelPosition" :rules="rules" ref="workorderForm" label-width="110px">
									...
									<el-tabs v-model="activeName">
										...
										<el-tab-pane label="检验检测项目与要求" name="second">
											<!-- <div class="table-func table-funcb">
												...
												<el-table :data="workorderForm.WORKORDER_PROJECTList" border stripe :fit="true" max-height="260" @cell-click="iconOperation" style="width: 100%;" :default-sort="{prop:'workorderbasisList', order: 'descending'}">
													...
													<el-table-column prop="LEADERDesc" label="责任人" sortable width="100px">
													</el-table-column>

													<el-table-column prop="ASSIST_PERSIONDesc" label="助手" sortable width="200px">
													</el-table-column>
													...
													<el-table-column prop="COMPLETE_DATE" label="完成日期" :formatter="dateFormat" sortable width="180px">
													</el-table-column>
											</el-table>
										</el-tab-pane>
										<!--检验/检测项目与要求 End-->
										...
										<el-tab-pane label="分包项目与要求" name="third">
											<el-table :data="workorderForm.WORKORDER_CONTRACTList" row-key="ID" border stripe :fit="true" highlight-current-row="highlight-current-row" style="width: 100%;" @cell-click="iconOperation" :default-sort="{prop:'workorderForm.WORKORDER_CONTRACTList', order: 'descending'}">
												...
												<el-table-column prop="LEADERDesc" label="责任人" sortable width="120px">
													<template slot-scope="scope">
														<el-input :disabled="true" v-if="scope.row.isEditing" size="small" v-model="scope.row.LEADERDesc" placeholder="请选择">
														</el-input>
														<span v-else>{{scope.row.LEADERDesc}}</span>
													</template>
												</el-table-column>

												<el-table-column prop="ASSIST_PERSIONDesc" label="助手" sortable width="120px">
													<template slot-scope="scope">
														<el-input :disabled="true" v-if="scope.row.isEditing" size="small" v-model="scope.row.ASSIST_PERSIONDesc" placeholder="请选择">
														</el-input>
														<span v-else>{{scope.row.ASSIST_PERSIONDesc}}</span>
													</template>
												</el-table-column>
										...
										<el-tab-pane label="检验检测设备" name="fourth">
											<el-table :data="workorderForm.WORKORDER_ASSETList" row-key="ID" border stripe :fit="true" highlight-current-row="highlight-current-row" style="width: 100%;" @cell-click="iconOperation" :default-sort="{prop:'dataInfo.INSPECT_PROXY_BASISList', order: 'descending'}">
												...
												<el-table-column prop="USE_PERSONDesc" label="使用人" sortable width="150px">
												</el-table-column>
											</el-table>
										</el-tab-pane>
										<!--检验检测设备 End-->
						...
						<!--this.STATE==5&&workorderForm.IS_MAIN!=1&&this.MASTER_INSPECTOR!=this.$store.state.currentuser.id&&this.STATE!='1'
		...
		data() {
			return {
				...
				workorderForm: {
					...
					WORKORDER_DATA_TEMPLATEList:[],//成果文件文件
