		...
		data() {
			return{
				...
				tableHeader: [ 
					...
					{ label: '任务编号', prop: 'param2' },
					{ label: '人工', prop: 'param3' },
					{ label: '工种', prop: 'param4' },
					{ label: '技能级别', prop: 'param5' },
					{ label: '数量', prop: 'param6' },
					{ label: '小时数', prop: 'param7' },
					{ label: '费率', prop: 'param8' },
					{ label: '成本', prop: 'param9' } 
				]
			}
		},
		methods: {
